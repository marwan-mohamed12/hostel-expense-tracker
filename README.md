...
- SweetAlert2 for destructive confirms; ngx-toastr for success/action toasts
...
| Dialogs | SweetAlert2 (confirms) + ngx-toastr (toasts) |
...
```text
src/app/
  core/           # constants, HostelStore, storage, SweetAlert + toast helpers
